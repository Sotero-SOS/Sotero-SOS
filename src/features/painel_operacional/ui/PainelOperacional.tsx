...
import type { Atendimento, Driver, Motivo, Veiculo } from "@/entities";
import {
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <strong
                                            className={`tempo-topo ${excedeuPrevisto
                                                    ? "aviso-topo"
                                                    : ""
                                                }`}
                                            title={
                                    ...
                                    <div style={{ display: "flex", gap: 8 }}>
                                        <span
                                            className={`badge ${i.status === "Fechado"
                                                    ? "ok"
                                                    : i.atrasado
                                                        ? "erro"
                                                        : "proc"
                                ...
                                <div className="lin">
                                    ...
                                    <span className="val">
                                        {i.veiculo
                                            ? `${i.veiculo.cod_veiculo} ${i.veiculo.categoria_id
                                                ? `(${i.veiculo.categoria_id})`
                                                : ""
                                            }`
                                            : i.cod_veiculo}
                                    </span>
